export const IpcChannel = {
  ...
  DocumentsMerge: 'documents:merge',
  ...
  AiChatHistoryPage: 'ai:chat:historyPage',
  AiChatRunSnapshot: 'ai:chat:runSnapshot',
  AiMediaResolve: 'ai:media:resolve',
  AiMediaTextPreview: 'ai:media:textPreview',
  AiMediaOpen: 'ai:media:open',
  AiMediaReveal: 'ai:media:reveal',
  AiMediaSave: 'ai:media:save',
  AiMediaCopy: 'ai:media:copy',
  ...
  EventAiChatMedia: 'ai:chat:media',
...
export const SERVER_IPC_CHANNELS = [
  ...
  IpcChannel.AiMediaResolve,
  IpcChannel.AiMediaTextPreview,
  IpcChannel.AiMediaOpen,
  IpcChannel.AiMediaReveal,
  IpcChannel.AiMediaSave,
  IpcChannel.AiMediaCopy,
